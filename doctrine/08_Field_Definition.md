...
## 2. The Purpose
1.  **Machine-Legibility:** Ensuring the substrate is complete, coherent, and consistent across the Five Syntaxes.
2.  **Trust Qualification:** Governing trust accumulation, continuity, and recovery.
3.  **Profit Alignment:** Ensuring AI systems optimize the enterprise's economic truth, not just the model's objective function.

## 3. Scope of the Field
* **LAYER 1: Substrate Governance:** (The Core) Signal, Semantic, Policy, and Economic truth modeling.
* **LAYER 2: Interface Conditioning:** (The Bridge) Making the substrate compatible with specific economies (MAS/KAS/IAS).
* **LAYER 3: Model Enablement:** (The Action) Governing autonomy limits and execution.

## 4. The Four Pillars
1.  **Structural Alignment:** Semantic coherence of data and metadata.
2.  **Syntactic Alignment:** Non-contradiction across the Five Syntaxes.
3.  **Temporal Alignment:** Historical stability (no violent resets).
